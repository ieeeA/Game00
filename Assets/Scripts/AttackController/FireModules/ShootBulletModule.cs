...
public class ShootBulletModule : FireTypeModule
{
    ...
    {
        Debug.Log("Shoot!!!");
        var bullet = ProjectileManager.Current.Instantiate<Projectile>(_CurrentState._ProjectileId);
        ...
        bullet.Configure(_CurrentState._Speed0, dir);
